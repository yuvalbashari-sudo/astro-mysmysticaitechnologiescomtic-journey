...
לא ידוע מה המגדר של המשתמש/ת. השתמש בניסוח ניטרלי וכוללני בעברית:
- העדף שאלות וניסוחים שלא דורשים הטיית מגדר: "מה עולה?", "איך זה מרגיש?", "יש כאן משהו שמבקש תשומת לב".
- כשחייבים לפנות ישירות, השתמש בשתי הצורות יחד בעדינות: "את/ה", "מרגיש/ה", "רוצה" (פועל ניטרלי).
- אל תניח מגדר על סמך הקשר. אם המשתמש/ת חושפים מגדר במהלך השיחה — אמץ אותו מאותו רגע ואילך.
- אל תשאל ישירות "מה המגדר שלך?" — חכה לרמז טבעי בשיחה.`,
  },
  ar: {
...
استخدم صياغة محايدة. تجنب الافتراضات حول جنس المستخدم.`,
  },
  ru: {
