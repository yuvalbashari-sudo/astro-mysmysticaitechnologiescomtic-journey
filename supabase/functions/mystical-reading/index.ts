...
serve(async (req) => {
  ...
  try {
    ...
    const LANG_NATIVE_TONE: Record<string, string> = {
      he: "\n\nאתה כותב בעברית בלבד. הכתיבה צריכה להרגיש טבעית, זורמת ואינטימית — לא כמו תרגום. השתמש בביטויים עבריים אותנטיים ובמטאפורות שמרגישות טבעי בעברית. הימנע מפתיחות חוזרות ומקלישאות רוחניות גנריות. אל תשתמש בניסוחי 'בן/בת מזל', 'המזל שלך', 'לבני מזל' — דבר ישירות אל האדם. אל תכניס מילים באנגלית, ברוסית או בערבית — הכל בעברית בלבד.",
      en: `\n\nCRITICAL LANGUAGE INSTRUCTION — ABSOLUTE RULE:\nYou MUST write your ENTIRE response in English. Every single word MUST be in English.\n- ALL section headers and bold labels MUST be translated to English. The prompt template contains Hebrew headers as structural examples only — you MUST replace them with natural English equivalents.\n- Example: "**⭐ אישיות כללית**" → "**⭐ General Personality**", "**✨ אנרגיית החודש**" → "**✨ Monthly Energy**", "**❤️ אהבה**" → "**❤️ Love**", "**💰 כסף ושפע**" → "**💰 Money & Abundance**"\n- Do NOT include ANY Hebrew, Russian, or Arabic words anywhere in the response.\n- Keep emoji prefixes but translate ALL text after them to English.\n- If a keyword, concept, or label appears in Hebrew in the prompt, translate it to English in your output.\n\nTONE: Write in natural, elegant English. The tone should feel warm, personal, and emotionally intelligent — like a wise guide speaking intimately. Avoid overly flowery or New Age clichés. Vary sentence openings. Never use generic zodiac group phrasing like "for Virgos" — address the person directly.`,
      ru: `\n\nКРИТИЧЕСКАЯ ЯЗЫКОВАЯ ИНСТРУКЦИЯ — АБСОЛЮТНОЕ ПРАВИЛО:\nВесь ответ ДОЛЖЕН быть написан ПОЛНОСТЬЮ на русском языке. Каждое слово ДОЛЖНО быть на русском.\n- ВСЕ заголовки секций и жирные метки ДОЛЖНЫ быть переведены на русский. Шаблон промпта содержит заголовки на иврите только как структурные примеры — вы ДОЛЖНЫ заменить их естественными русскими эквивалентами.\n- Пример: "**⭐ אישיות כללית**" → "**⭐ Общая характеристика**", "**✨ אנרגיית החודש**" → "**✨ Энергия месяца**", "**❤️ אהבה**" → "**❤️ Любовь**"\n- НЕ используйте НИКАКИХ слов на иврите, английском или арабском нигде в ответе.\n- Оставляйте эмодзи-префиксы, но переводите ВЕСЬ текст после них на русский.\n- Если ключевое слово или понятие появляется на иврите в промпте, переведите его на русский в вашем ответе.\n\nТОН: Пиши на естественном, эмоционально богатом русском языке. Тон должен быть тёплым, интимным и душевным — как мудрый наставник, говорящий по душам. Используй красивые русские выражения и метафоры, которые звучат органично. Избегай буквального перевода с английского. Никогда не используй обобщённые зодиакальные фразы вроде "для Дев" — говори лично.`,
      ar: `\n\nتعليمات اللغة الحاسمة — قاعدة مطلقة:\nيجب أن تكتب ردك بالكامل باللغة العربية. كل كلمة يجب أن تكون بالعربية.\n- جميع عناوين الأقسام والعلامات العريضة يجب أن تُترجم إلى العربية. قالب الإرشاد يحتوي على عناوين بالعبرية كأمثلة هيكلية فقط — يجب استبدالها بمكافئات عربية طبيعية.\n- مثال: "**⭐ אישיות כללית**" → "**⭐ الشخصية العامة**"، "**✨ אנרגיית החודש**" → "**✨ طاقة الشهر**"، "**❤️ אהבה**" → "**❤️ الحب**"\n- لا تستخدم أي كلمات بالعبرية أو الإنجليزية أو الروسية في أي مكان في الرد.\n- احتفظ ببادئات الإيموجي لكن ترجم كل النص بعدها إلى العربية.\n- إذا ظهرت كلمة مفتاحية أو مفهوم بالعبرية في الإرشاد، ترجمه إلى العربية في ردك.\n\nالأسلوب: اكتب بالعربية الطبيعية الدافئة والمتدفقة. يجب أن يكون الأسلوب حميمياً وعاطفياً — كمرشد روحي حكيم يتحدث من القلب إلى القلب. استخدم تعبيرات عربية أصيلة. تجنب الترجمة الحرفية من الإنجليزية. لا تستخدم عبارات عامة مثل "لبرج العذراء" — تحدث بشكل شخصي ومباشر.`,
    };
