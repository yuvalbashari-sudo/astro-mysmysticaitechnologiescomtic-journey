...
שם הקורא/ת: "${name}".
- פנה אל הקורא/ת בשמו/ה הפרטי בפתיחה ובמסר האישי.
- השתמש בשם באופן טבעי, בעיקר בשורות פתיחה וברגעים רגשיים מרכזיים.
- אל תחזור על השם בכל משפט — זה צריך להרגיש אנושי וחם.
- דוגמה: "היום, ${name}, הקלף שלך מביא מסר חשוב..." או "${name}, יש כאן הזמנה לעצור ולהקשיב..."
- אל תשתמש בביטויים כמו "בן מזל X", "בת מזל Y", "לבני מזל..." — דבר ישירות ואישית.`
      : `\n\nהנחיית פנייה — חשוב:
- לא ידוע שם הקורא/ת. פנה אליו/ה בגוף שני באופן אישי וחם.
- אל תשתמש בביטויים כמו "בן מזל X", "בת מזל Y", "לבני מזל..." — השתמש בפנייה ישירה: "היום הקלף שלך מבקש ממך...", "יש כאן מסר אישי עבורך..."
- הטון צריך להרגיש אינטימי, כאילו אתה מדבר עם חבר/ה קרוב/ה.`;
