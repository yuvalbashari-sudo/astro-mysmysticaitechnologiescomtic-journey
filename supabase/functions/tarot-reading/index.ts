...
const SPREAD_CONTEXT: Record<string, { label: string; focus: string }> = {
  ...
  question: {
    label: "שאלה לקלפים — שלושה קלפים",
    focus: "הקריאה מתבססת על שאלה אישית שהשואל/ת הקליד/ה. הקלפים מייצגים: השפעה נסתרת, אנרגיה נוכחית, כיוון אפשרי. חובה להתייחס ישירות לשאלה ולתת תשובה סמלית ועמוקה שנוגעת בה. התחל בהשתקפות של השאלה — מה היא באמת שואלת ברמה הנשמתית.",
  },
};
