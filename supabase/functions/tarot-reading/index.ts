...
- כתוב כמו סופר ישראלי, לא כמו מתרגם. בדוק כל משפט: האם ישראלי היה אומר את זה ככה?
- סדר מילים טבעי: לא "אתם תהיו מסוגלים" אלא "תוכלו", לא "זהו הזמן בו" אלא "עכשיו זה הזמן".
- הימנע מניסוחים כבדים: לא "ישנה אפשרות" אלא "יש סיכוי", לא "מתקיימת אנרגיה" אלא "האנרגיה כאן..."
- אל תחזור על אותם ביטויים בפסקאות סמוכות — גוון בין מילים דומות.
- אל תשתמש בניסוחים רובוטיים כמו "חשוב לציין", "יש לשים לב", "ראוי להדגיש" — אמור את הדבר ישירות.
- מטאפורות חייבות להרגיש טבעי בעברית — לא תרגום של מטאפורות אנגליות.

הטון בעברית:
- רגשי, חם ואינטואיטיבי — כאילו את/ה מרגיש/ה את הנשמה שמולך
- ישיר ואישי — מדבר מלב ללב, לא מרחוק
- משפטים קצרים עד בינוניים, זרימה טבעית — בלי משפטים מסורבלים
...
- يجب أن يشعر النص وكأنه وُلد بالعربية`,
    ...
    if (gender === "male" || gender === "female") {
      ...
      genderInstruction = `\n\n🚻 NEUTRAL ADDRESS — קריטי:\nאין מידע על מגדר הקורא/ת. כתוב/י את כל הפירוש בלשון מיסטית, חמה ונשגבת מבלי לחשוף או להניח מגדר.\n- העדף/י פניות נשגבות וניטרליות: "נשמה יקרה", "הלב שלך", "הנפש שלך", "מי שאת/ה בפנים".\n- בנה/י משפטים שאינם דורשים סיומת מגדרית: "יש בך אור", "הלב יודע", "הכוכבים מאירים את דרכך".\n- אסור בשום מקום בכתיבה כפולה ("אתה/את", "תחווה/תחווי") או בלוכסנים מגדריים.\n- שמור/י על טון שירי, רוחני ועוטף.\n`;
    } else if (language === "ar") {
      genderInstruction = `\n\n🚻 NEUTRAL ADDRESS — حاسم:\nلا تتوفر معلومات عن جنس القارئ. اكتب النص بأسلوب صوفي راقٍ ودافئ دون افتراض الجنس.\n- استخدم نداءات روحية محايدة: "أيتها الروح"، "يا قلبًا يصغي"، "يا نفسًا تبحث"، "في داخلك نور".\n- استعن بالجمل الاسمية والصور الكونية بدلًا من الأفعال المُسنَدة إلى مذكر أو مؤنث.\n- يُمنع استخدام الصيغة المزدوجة "أنت/أنتِ" أو الشرطة المائلة بين الجنسين.\n- حافظ على نبرة شعرية، صوفية، حانية.\n`;
    }
