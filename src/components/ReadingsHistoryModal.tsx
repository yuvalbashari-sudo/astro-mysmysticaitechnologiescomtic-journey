...
const ReadingsHistoryModal = ({ isOpen, onClose }: Props) => {
  ...
  return (
    <CinematicModalShell isOpen={isOpen} onClose={onClose} scrollRef={scrollRef as React.RefObject<HTMLDivElement>} wide>
        <div className="p-8 md:p-12 pt-12 md:pt-16 max-w-2xl" dir={dir} style={{ marginRight: "auto", marginLeft: "-25px" }}>
                    ...
                    return (
                      ...
                      >
                        <button
                          ...
                          className="w-full flex items-center gap-5 p-6 text-right hover:bg-gold/5 transition-colors"
