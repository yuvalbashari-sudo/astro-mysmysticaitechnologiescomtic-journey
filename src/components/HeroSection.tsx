...
const HeroSection = () => {
  ...
  return (
    ...
    <section className="relative z-10 min-h-screen flex flex-col items-center justify-center overflow-x-hidden pointer-events-none" style={{ background: "transparent" }}>
      {/* Content container */}
