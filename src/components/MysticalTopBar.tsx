...
const MysticalTopBar = ({ onOpenHistory, hasHistory }: Props) => {
  ...
  return (
    <motion.header
      className="fixed top-0 left-0 right-0 z-[60] flex items-center justify-between px-4 md:px-6 py-3"
          ...
          <AnimatePresence>
            {langOpen && (
              <motion.div
                ...
                className="absolute top-full mt-2 left-0 rounded-xl overflow-hidden"
                style={{
