...
const MysticalTopBar = ({ onOpenHistory, onOpenDashboard, hasHistory }: Props) => {
  ...
  return (
    <motion.header
      className="fixed top-0 left-0 right-0 z-[60] px-2 sm:px-4 md:px-8 py-2 md:py-3"
      dir={dir}
      ...
      {isMobile ? (
        ...
        <div className="flex flex-col items-center gap-1.5">
          ...
          <div className="flex items-center justify-between w-full">
            ...
            {/* Centre logo */}
            <div className="flex-shrink pointer-events-none select-none mx-0.5 min-w-0 overflow-hidden">
              <motion.h1
