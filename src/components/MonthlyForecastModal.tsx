...
const MonthlyForecastModal = ({ isOpen, onClose }: Props) => {
  ...
  return (
    <CinematicModalShell isOpen={isOpen} onClose={handleClose} scrollRef={scrollRef as React.RefObject<HTMLDivElement>} fullscreen hideAdvisor={!!signInfo && !isMobile}>
                ...
                isDesktopResult ? (
                  ...
                  <div className="absolute inset-0">
                    ...
                    <motion.div
                      ...
                      style={{ top: "calc(10vh + 56px)", left: "calc(3vw - 10px)", width: "min(440px, 38vw)", maxHeight: "80vh", maxWidth: "calc(100vw - 10px)" }}
